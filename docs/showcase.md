...
Install the current released v0.4.0 command from production PyPI:
...
The production v0.4.0 release notes summarize validation scope and the
contained-run trust boundary. See
