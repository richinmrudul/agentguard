...
def _cli_smoke() -> list[dict[str, object]]:
    ...
    passed = version.returncode == 0 and version.stdout.strip() == "0.1.0"
    results.append(
        {
...
def build_readiness_summary() -> dict[str, Any]:
    return {
        ...
        "scope": "local-first v0.1 readiness; no publishing or tag creation",
        ...
        "validation_summary": {
            ...
            "phase36a_local_result": "passed before opening the review PR",
        },
        "known_limitations": [
...
def _markdown(summary: dict[str, Any]) -> str:
    ...
    return f"""# v0.1 Release Readiness
...
Phase 36A local result: {validation["phase36a_local_result"]}.
